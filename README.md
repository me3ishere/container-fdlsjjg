...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-fdlsjjg.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-fdlsjjg.containers.anotherwebservice.com/
...
```
git clone git@github.com:me3ishere/container-fdlsjjg.git
cd container-fdlsjjg
```
...
```
docker attach container-fdlsjjg
```
